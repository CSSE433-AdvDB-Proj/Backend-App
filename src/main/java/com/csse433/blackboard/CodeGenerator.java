...
//        dsc.setUrl("jdbc:mysql://localhost:3306/blackboard?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
//        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
//        dsc.setUsername("admin");
//        dsc.setPassword("DidiHenryChet");
//        mpg.setDataSource(dsc);
//
//        // 包配置
//        PackageConfig pc = new PackageConfig();
//        pc.setParent("com.csse433.blackboard.rdbms");
